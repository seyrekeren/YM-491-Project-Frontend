...
const VideoList = () => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:5000/api/channel/oyunGeliştirmeVideos')
    ...
    const handleVideoClick = (s3Url) => {
        // Tıklanan video linkine yönlendirme yapmak için
        // Örneğin, tıklanan linkte videoyu oynatabilecek başka bir sayfa açılabilir
